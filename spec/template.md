...
Copy this file to `<your-project>/AGENTS.md` and fill in the sections that apply. Delete sections that don't — empty headings are not the convention.

For the full spec see [schema.md](schema.md).
...
**Topics:**
- [topic name](../agent-wiki/topics/<slug>.md) — <why it's relevant here>
